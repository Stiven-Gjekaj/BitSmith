...
about: Suggest a tool, a format, or a change to a decision
title: ""
labels: enhancement
assignees: ""
---
...
Describe the task in the words a visitor would use.
For example: "turn a HEIC photo from my phone into a JPEG".

## The file in, and the file out

- What you start with:
- What you want back:

## Why the current tools do not do it

Say whether a tool exists and handles it badly, or whether none exists.
